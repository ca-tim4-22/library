            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="username" class="col-md-4 col-form-label text-md-end">{{ __('Korisničko ime') }}</label>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input id="JMBG" type="text" class="form-control @error('JMBG') is-invalid @enderror" name="JMBG" value="{{ old('JMBG') }}" required autocomplete="email">

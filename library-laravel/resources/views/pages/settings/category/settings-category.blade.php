            ...
            <table class="overflow shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]" id="myTable">
                <thead class="bg-[#EFF3F6]">
                    <tr class="border-b-[1px] border-[#e4dfdf]">
                        ...
                        <th class="px-4 py-4 text-sm leading-4 tracking-wider text-left">Opis kategorije</th>
                ...
                <tbody class="bg-white">
                        ...
                        <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                            ...
                            <div
                                ...
                                <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                    ...
                                    <div class="py-1">
                                        <a href="{{route('edit-category', $category->id)}}" tabindex="0"
                    ...
                    <div class="mx-[50px]">
                        <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">                       
                            ...
                            <p class="font-medium text-white">Trenutno nemakw kategorija u bazi podataka! </p>
                        </div>
                    </div>  

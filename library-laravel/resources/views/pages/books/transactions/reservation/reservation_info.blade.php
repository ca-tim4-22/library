        ...
        <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
            <div class="py-[10px] flex flex-row">
                <div class="w-[77px] pl-[30px]">
                    @foreach ($reservation->book->gallery->where('cover', 1)->get() as $cover_photo)
                    <img 
            ...
            <div class="pt-[24px] mr-[30px]">
                <a href="{{route('write-off', $reservation->book->id)}}" class="inline hover:text-blue-600">
                    <i class="fas fa-level-up-alt mr-[3px]"></i>
                    Otpiši knjigu
                </a>
                <a href="{{route('rent-book', $reservation->book->id)}}" class="inline hover:text-blue-600 ml-[20px] pr-[10px]">
                    <i class="far fa-hand-scissors mr-[3px]"></i>
                    Izdaj knjigu
                </a>
                <a href="{{route('return-book', $reservation->book->id)}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                    <i class="fas fa-redo-alt mr-[3px] "></i>
                    Vrati knjigu
                </a>
                <a href="{{route('reserve-book', $reservation->book->title)}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                ...
                <div
                    ...
                    <div class="absolute right-0 w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                        ...
                        <div class="py-1">
                            <a href="{{route('edit-book', $reservation->book->id)}}" tabindex="0"
                ...
                <div class="flex flex-row justify-between">
                    <div class="mr-[30px]">
                        ...
                        <div class="mt-[40px]">
                            ...
                            <p class="font-medium">
                                @php
                                $datetime1 = new DateTime(($reservation->reservation_date));
                                $datetime2 = new DateTime(($reservation->request_date));
                        ...
                        <div class="mt-[40px]">
                            ...
                            <p class="font-medium">
                                ...
                                $date2 = new DateTime($reservation->request_date);

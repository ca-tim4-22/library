...
class ReturnBookController extends Controller
{
            ...
            foreach ($books as $book) {
                foreach ($book->rent as $rent) {
                    foreach ($rent->rent_status as $key) {
                        $data = $key->where('book_status_id', 2)->orderBy('id',
                            'desc');
                    }
                }
            }
    ...
    public function create(Book $book)
    {
        ...
        return view('pages.books.transactions.return.return_book',
            compact('data', 'get_book', 'variable'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('returned-books')->with('return-success',
            'Vratili ste knjigu.');
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.books.transactions.return.return_info',
            compact('rent'));
    }

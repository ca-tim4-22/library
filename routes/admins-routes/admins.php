...
Route::get('/izmijeni-profil-administratora/{user:username}', 'edit')->name('edit-admin');
Route::put('/izmijeni-profil-administratora/{id}', 'update')->name('update-admin');

// Delete ownself
Route::delete('/izbrisi-administratora/{id}', 'destroy')->name('destroy-admin');

// For multiple student delete
Route::delete('izbrisi-sve/administratore', 'deleteMultiple')->name('delete-all-admins');

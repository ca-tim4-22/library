...
Route::get('/izmijeni-profil-bibliotekara/{user:username}', 'edit')->name('edit-librarian');
Route::put('/izmijeni-profil-bibliotekara/{id}', 'update')->name('update-librarian');

// Additional features

// Delete ownself
Route::delete('/izbrisi-bibliotekara/{id}', 'destroy')->name('destroy-librarian');

// For multiple librarian delete
Route::delete('izbrisi-sve/bibliotekare', 'deleteMultiple')->name('delete-all-librarians');
...
Route::post('/bibliotekari/{id}', 'destroy')->name('librarians.destroy');
});

Route::post('/resetuj-lozinku/{user}', 'resetPassword')->name('resetPassword');

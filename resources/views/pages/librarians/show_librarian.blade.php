...
@section('title')
    ...
    <!-- Title -->
    <title>{{__('Profil bibliotekara | Online biblioteka')}}</title>
                ...
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <div
                            ...
                            <div
                                class="absolute right-0 w-16 mt-[10px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                ...
                                <div class="py-1">
                                    ...
                                    <button type="submit"
                                            ...
                                            data-action="{{ route('destroy-librarian',
                                    $librarian->id) }}"
                ...
                <div class="flex flex-row">
                    <div class="mr-[30px]">
                        ...
                        <div class="mt-[40px]">
                            ...
                            <p class="font-medium">{{__($librarian->gender->name)}}</p>
                        </div>
                        <div class="mt-[40px]">
                            ...
                            <p class="font-medium">
                                @if ($librarian->login_count <= 0)
                                    @if ($librarian->gender->id == 1)
                                        {{__('Bibliotekar se nikada nije ulogovao na platformu.')}}
                                    @else
                                        {{__('Bibliotekarka se nikada nije ulogovala na platformu.')}}
                                    @endif
                                @else
                        ...
                        <div class="mt-[40px]">
                            <span
                                class="text-gray-500">{{__('Poslednji put')}} {{$librarian->gender->id == 1 ? 'ulogovan' : 'ulogovana'}}</span>
                            <p class="font-medium">
                                @if ($librarian->login_count <= 0)
                                    @if ($librarian->gender->id == 1)
                                        {{__('Bibliotekar se nikada nije ulogovao na platformu.')}}
                            ...
                            <label class="mt-6 cursor-pointer">
                                <div id="empty-cover-art"
                                    ...
                                    <div class="py-4">
                                        ...
                                        <span
                                            class="px-4 py-2 mt-2 leading-normal">{{__('Izmijeni fotografiju')}}</span>
    ...
    <div
        ...
        <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
            ...
            <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
                ...
                <h3>{{__('Resetuj lozinku')}}: {{$librarian->name}}</h3>

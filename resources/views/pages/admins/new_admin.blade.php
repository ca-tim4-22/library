...
<!-- Title -->
<title>Registracija novog administratora | Online Biblioteka</title>
...
@section('content')
 ...
 <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
                ...
                <div>
                    <nav class="w-full rounded">
                        <ol class="flex list-reset">
                            ...
                            <li>
                                <a href="{{route('new-admin')}}" class="text-gray-400 hover:text-blue-600">
                                    Novi administrator
                                </a>
                            </li>
                        </ol>
    ...
    <div class="scroll height-content section-content">
        <form class="text-gray-700 text-[14px]" method="POST" action="{{route('store-admin')}}" enctype="multipart/form-data">
        @csrf

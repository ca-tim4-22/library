            ...
            <table id="sort" class="shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]" id="myTable">
                ...
                <tbody class="bg-white" id="tablex">
                    ...
                    <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                        ...
                        <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">{{$admin->login_count == 0 ? __('Korisnik se nikada nije ulogovao.') : $admin->last_login_at->diffForHumans()}}</td>
                        <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                            ...
                            <div
                                ...
                                <div class="absolute right-[25px] w-16 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                    ...
                                    <div class="py-1">
                                        <a href="{{route('show-admin', $admin->username)}}" tabindex="0"
                                        ...
                                        <a 
                                        href="{{route('edit-admin', $admin->username)}}" tabindex="0"
                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                            role="menuitem">

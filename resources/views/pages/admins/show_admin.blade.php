        ...
        <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
            <div class="pl-[30px] py-[10px] flex flex-col">
                ...
                <div class="pt-[24px] pr-[30px]">
                    ...
                    <a href="{{route('edit-admin', $admin->username)}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                    ...
                    <div
                        ...
                        <div class="absolute right-0 w-16 mt-[10px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                            ...
                            <div class="py-1">
                                ...
                                @if (Auth::id() == $admin->id)
                                data-id="{{$admin->id}}" 
                                data-action="{{ route('destroy-admin', $admin->id) }}" 
                                onclick="deleteAccountStudent({{$admin->id}})" 
                                @else
                                data-id="{{$admin->id}}" 
                                data-action="{{ route('destroy-yourself', $admin->id) }}" 
...
@endif
            ...
            <div class="flex flex-row">
                <div class="mr-[30px]">
                    ...
                    @else 
                    Administratorka se nikada nije ulogovala na platformu.
                    @endif
                    @else
                    {{$admin->login_count}}
                    @endif

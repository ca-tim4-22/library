        ...
        <div class="section-">
            ...
            <div class="flex flex-col">
                ...
                <div class="pl-[30px] py-[20px] flex border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="relative ml-[60px] mt-[20px]">
                        <form class="flex" method="POST"
                              action="{{route('update-policy', $policy1->id)}}">
                            @csrf
                            @method('PUT')
                            <button
                                    id="edit-btn"
                ...
                <div class="pl-[30px] py-[20px] flex border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="relative ml-[60px] mt-[20px]">
                        <form class="flex" method="POST"
                              action="{{route('update-policy', $policy2->id)}}">
                            @csrf
                            @method('PUT')
                            <button
                                    id="edit-btn"
                ...
                <div class="pl-[30px] py-[20px] flex border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="relative ml-[60px] mt-[20px]">
                        <form class="flex" method="POST"
                              action="{{route('update-policy', $policy3->id)}}">
                            @csrf
                            @method('PUT')
                            <button
                                    id="edit-btn"
                    ...
                    <div>
                        ...
                        <p class="pt-[15px] max-w-[400px]">
                            ...
                            <span style="color: #4558BE">5</span>, <span
                                    style="color: #4558BE">10</span>, <span
                                    style="color: #4558BE">25</span>, <span
                                    style="color: #4558BE">50</span> i <span
                                    style="color: #4558BE">100</span>
                        </p>
                    </div>
                    <div class="relative ml-[60px] mt-[20px]">
                        <form class="flex" method="POST"
                              action="{{route('update-pagination', $policy4->id)}}">
                            @csrf
                            @method('PUT')
                            <button
                                    id="edit-btn"
                ...
                <div>
                    <p style="margin-left: 1%;margin-top: 1%"
                       class="text-sm text-red-500">{{ $message }}</p>
                </div>
                @enderror

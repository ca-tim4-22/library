...
<!-- Title -->
<title>{{__('Podešavanja | Kategorije - Online biblioteka')}}</title>
...
<section class="w-screen h-screen py-4 pl-[80px] text-[#333333]">
    ...
    <div class="heading mt-[7px]">
        <div class="heading mt-[7px]" style="margin-top: 10px">
            ...
            <h1 style="font-size: 30px"
                ...
                {{__('Podešavanja')}}
                {{-- Session message for category create --}}
    ...
    <div style="display:none;" id="myDiv">
        <div class="height-kategorije pb-[30px] scroll">
            <div class="flex items-center justify-between px-[50px] py-8 space-x-3 rounded-lg">
                ...
                <div class="flex items-center">
                    ...
                    <form method="GET" action="{{ route('setting-category') }}">
        ...
        <div class="inline-block min-w-full px-[50px] pt-3 align-middle bg-white rounded-bl-lg rounded-br-lg shadow-dashboard">
            ...
            <button type="submit"
                    class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE] button delete-all-categories"
                    data-url="">
                <div class="icon">
                    <svg class="top">
                        <use xlink:href="#top">
            ...
            <table id="sort"
                ...
                <tr class="border-b-[1px] border-[#e4dfdf]">
                    ...
                    <td style="width: 200px"
                        ...
                        <button
                            ...
                            <span style="padding-top: 1px;">{{__('Izmijeni kategoriju')}}</span>
                        </button>
                    </td>
                    ...
                    <td class="px-3 py-5 leading-4 tracking-wider text-left sakriveno checkme2">
                        <button
                            ...
                            <span style="padding-top: 1px;">{{__('Izbriši kategoriju')}}</span>
                        </button>
                    </td>
                    ...
                    <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                        ...
                        <div
                            ...
                            <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                ...
                                <div class="py-1">
                                    <a href="{{route('edit-category', $category->name)}}"
                                       tabindex="0"
                                       class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                       role="menuitem">
                                        <i class="fas fa-edit mr-[1px] ml-[5px] py-1"></i>
                                        <span class="px-4 py-0">{{__('Izmijeni kategoriju')}}</span>
                                    </a>
                                    <button
                                            data-id="{{ $category->id }}"
                ...
                <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                    ...
                    <p class="font-medium text-white">{{__('Trenutno nema kategorija u bazi podataka!')}}</p>
                </div>

        ...
        <div class="pb-[30px] scroll">
            ...
            <div class="flexx">
                ...
                <div class="one" style="margin: 100px;font-size: 50px">
                    ...
                    <br>
                    <p class="counter"
                       data-count="{{$data['librarianCount']}}"></p>
                    <p>
                        @php
                        if($data['librarianCount'] % 10 == 1 &&
                        $data['librarianCount'] != 11) {
                        echo __('Bibliotekar');
                        } else {
                ...
                <div class="one" style="margin: 100px;font-size: 50px">
                    ...
                    <br>
                    <p class="counter"
                       data-count="{{$data['studentCount']}}"></p>
                    <p>
                        @php
                        if($data['studentCount'] % 10 == 1 &&
                        $data['studentCount'] != 11) {
                        echo __('Učenik');
                        } else {
                        echo __('Učenika');
                        }
            ...
            <div class="flexx">
                ...
                <div class="one" style="margin: 0px 100px;font-size: 50px">
                    ...
                    <br>
                    <p class="counter"
                       data-count="{{$data['librarianToday']}}"></p>
                    <p>
                        @php
                        if($data['librarianToday'] % 10 == 1 &&
                        $data['librarianToday'] != 11) {
                        echo __('Bibliotekar');
                        } else {
                        echo __('Bibliotekara');
                        }
                ...
                <div class="one" style="margin: 100px;font-size: 50px">
                    ...
                    <br>
                    <p class="counter"
                       data-count="{{$data['studentToday']}}"></p>
                    <p>
                        @php
                        if($data['studentToday'] % 10 == 1 &&
                        $data['studentToday'] != 11) {
                        echo __('Učenik');
                        } else {
                        echo __('Učenika');
                        }

    ...
    <head>
        ...
        <style>
            ...
            *:after {
            ...
            a:hover,
            a:focus {
                border-bottom-color: #283998 !important;
                color:red;
                transition: 0.3s
            }
            img {
    ...
    <body id="preview">
     ...
     <div class="body2">
        ...
        <p class="has-line-data" data-line-start="5" data-line-end="6">
            Svaki zapis se sastoji od jednog ili više polja, odvojenih zarezima. Upotreba zareza kao separatora polja je izvor imena za ovaj format datoteke. CSV datoteka obično skladišti tabelarne podatke (brojeve i tekst) u običnom
            tekstu, u kom slučaju će svaki red imati isti broj polja.
        </p>
        <p class="has-line-data" data-line-start="7" data-line-end="8">
            Format CSV datoteke nije u <strong>potpunosti</strong> standardizovan. Razdvajanje polja zarezima je osnova, ali zarezima u podacima ili ugrađenim prelomima redova treba posebno postupati. Neke implementacije onemogućavaju takav
            sadržaj, dok druge okružuju polje navodnicima, što opet stvara potrebu za izbjegavanjem ako su navodnici prisutni u podacima.
        </p>
        ...
        <ul>
            <li class="has-line-data" data-line-start="24" data-line-end="27">
                u prvom redu Vaše CSV datoteke uvijek moraju biti nazivi kolona koji se nalaze u tabeli koju želite da popunite i to na sledeći način:<br />
                <code>NameSurname,biography,wikipedia</code><br />
                <strong>P.S.</strong> Nakon naziva poslednje kolone se ne stavlja znak odvajanja (najčešće zarez)
            </li>
        ...
        <a href="mailto:nullable@gmail.com">
           nullable@gmail.com
        </a>
        <br>
        <br>
        <h4 class="code-line" data-line-start="37" data-line-end="38"><a id="Elektrotehnika_kola_Vaso_Aligrudi_37"></a>Elektrotehnička škola “Vaso Aligrudić”</h4>
        <p class="has-line-data" data-line-start="38" data-line-end="46">
            <img
            width="900px"
                src="https://scontent-atl3-2.xx.fbcdn.net/v/t39.30808-6/289692974_462866352508985_1895167965025343594_n.jpg?_nc_cat=104&amp;ccb=1-7&amp;_nc_sid=e3f864&amp;_nc_ohc=HKg6fVtUKFMAX87Eomf&amp;tn=hJtsgmpn8aC0uVcz&amp;_nc_ht=scontent-atl3-2.xx&amp;oh=00_AT-KvILUriQ_3a43AZU4ujqZ_YYdTuLbMoLv_QDMk2j5Bg&amp;oe=633BFBF9"
            />
            <br />
            <a href="https://elektropg.online/" target="_blank">Website</a><br />
            <a href="https://www.facebook.com/elektropg" target="_blank">Facebook</a><br />
            <a href="https://www.instagram.com/elektrotehnicka_skola_pg/" target="_blank">Instagram</a><br />
            <a href="https://www.youtube.com/channel/UC6eH4gJ0xKDJYwpNgbON8VQ" target="_blank">YouTube</a><br />
            ✉️Email: <a href="mailto:nullable@gmail.com">
                nullable@gmail.com
            </a>
            <br />
            📞Kontakt: 

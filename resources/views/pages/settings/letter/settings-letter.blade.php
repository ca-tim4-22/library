...
<section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
        ...
        <div class="heading mt-[7px]" style="margin-top: 10px">
            <h1 style="font-size: 30px"
                ...
                <script>
                    swal({
                        title: "@lang('Uspješno!')",
                        text: "@lang('Izmijenili ste pismo!')",
                        timer: 2500,
                        type: "success",
                    });
                </script>
    ...
    <div style="display:none;" id="myDiv">
        ...
        <div class="inline-block min-w-full px-[50px] pt-3 align-middle bg-white rounded-bl-lg rounded-br-lg shadow-dashboard">
            ...
            <button type="submit"
                    class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE] button delete-all-letters"
                    data-url="">
                <div class="icon">
                    <svg class="top">
                        <use xlink:href="#top">
                    ...
                    <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                        ...
                        <div
                            ...
                            <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                ...
                                <div class="py-1">
                                    <a href="{{route('edit-letter', $letter->name)}}"
                                       tabindex="0"
                                    ...
                                    <button
                                            data-id="{{ $letter->id }}"
                                            data-action="{{ route('letters.destroy', $letter->id) }}"
                                            onclick="deleteConfirmation({{$letter->id}})"
...
<script type="text/javascript">
    function deleteConfirmation(id) {
        swal({
            title: "@lang('Izbriši?')",
            text: "@lang('Da li ste sigurni da želite da izbrišete pismo?"')",
            type: "warning",
            showCancelButton: !0,
            timer: '5000',
            animation: true,
    ...
    $(document).ready(function () {
        ...
        $('.delete-all-letters').on('click', function (e) {
            ...
            if (idsArr.length <= 0) {
                ...
                swal({
                    title: "@lang('Greška!')",
                    text: "@lang('Morate selektovati makar jedno pismo.')",
                    type: "error",
                    timer: 1500,

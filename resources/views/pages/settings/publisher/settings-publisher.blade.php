...
<!-- Title -->
<title>{{__('Podešavanja | Izdavači - Online biblioteka')}}</title>
...
<section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
    ...
    <div style="display:none;" id="myDiv">
            ...
            <div class="flex items-center justify-between px-[50px] py-8 space-x-3 rounded-lg">
                <a href="{{route('new-publisher')}}"
                   class="btn-animation inline-flex items-center text-sm py-2.5 px-5 transition duration-300 ease-in rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE]">
                    <i class="fas fa-plus mr-[15px]"></i> {{__('Novi izdavač')}}
                </a>
                <div class="flex items-center">
                    ...
                    <form method="GET"
                          action="{{ route('setting-publisher') }}">
        ...
        <div class="inline-block min-w-full px-[50px] pt-3 align-middle bg-white rounded-bl-lg rounded-br-lg shadow-dashboard">
            ...
            <button type="submit"
                    class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE] button delete-all-publishers"
                    data-url="">
                <div class="icon">
                    <svg class="top">
                        <use xlink:href="#top">
                ...
                <tr class="border-b-[1px] border-[#e4dfdf]">
                    ...
                    <td class="px-3 py-5 leading-4 tracking-wider text-left sakriveno checkme2">
                        <button
                            ...
                            <span style="padding-top: 1px;">{{__('Izmijeni izdavača')}}</span>
                        </button>
                    </td>
                    ...
                    <td class="px-3 py-5 leading-4 tracking-wider text-left sakriveno checkme2">
                        <button
                            ...
                            <span style="padding-top: 1px;">{{__('Izbriši izdavača')}}</span>
                        </button>
                    </td>
                                ...
                                <div class="py-1">
                                    <a href="{{route('edit-publisher', $publisher->name)}}"
                                       ...
                                       role="menuitem">
                                        ...
                                        <span class="px-4 py-0">{{__('Izmijeni izdavača')}}</span>
                                    </a>

                                    <button
                                            data-id="{{ $publisher->id }}"
                                            data-action="{{ route('publishers.destroy', $publisher->id) }}"
                                            onclick="deleteConfirmation({{$publisher->id}})"
    ...
    <p class="font-medium text-white">{{__('Trenutno nema izdavača u bazi podataka!')}}</p>
    </div>

                ...
                <div>
                    <h1>
                         ...
                         <div id="hideDiv" class="flex p-2 mt-2 mb-1 text-sm text-green-700 bg-green-200 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                             ...
                             <div>
                                 <span class="font-medium">Uspješno!</span> {{session('publisher-updated')}}
                             </div>
                          </div>
                          @endif
                ...
                <div>
                    <nav class="w-full rounded">
                        ...
                        <li>
                            ...
                            <li>
                                <a href="{{route('edit-publisher', $publisher->id)}}" class="text-gray-400 hover:text-blue-600">
                                    Izmijeni podatke
                                </a>
                            </li>
                        </ol>
        ...
        <form class="text-gray-700" method="POST" action="{{route('update-publisher', $publisher->id)}}">
            ...
            <div class="flex flex-row ml-[30px]">
                <div class="w-[50%] mb-[150px]">
                    <div class="mt-[20px]">
                        <span>Naziv izdavača <span class="text-red-500">* @error('name'){{$message}} @enderror</span></span>
                        <input type="text" name="name" id="name" value="{{$publisher->name}}" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsNazivIzdavacEdit()"/>

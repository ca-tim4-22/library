...
<!-- Title -->
<title>{{__('Otpiši knjigu | Online biblioteka')}}</title>
...
<section class="w-screen h-screen pl-[80px] pb-2 text-gray-700">
    ...
    <div class="scroll height-dashboard px-[30px]">
        ...
        <div
            ...
            <form action="{{route('update-write-off', $book->id)}}"
                  method="POST">
                @csrf @honeypot
                ...
                <table class="min-w-full border-[1px] border-[#e4dfdf]"
                    ...
                    @foreach ($book->rent->where('return_date', '<', now()) as
                    $rent)
        ...
        <div class="mx-[50px]">
            <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                ...
                <p class="font-medium text-white">Trenutno nema primjeraka u
                    prekoračenju za otpisivanje! </p>
            </div>
        </div>
    </div>

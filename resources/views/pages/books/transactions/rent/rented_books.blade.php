...
<section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
    ...
    <div class="w-full mt-[10px] ml-2 px-2">
        ...
        <div style="display:none;" id="myDiv2">
            ...
            <table id="sort"
                   class="shadow-lg rounded-xl w-full border-[1px] border-[#e4dfdf]">
                            ...
                            <label class="flex items-center justify-start">
                                <div
                                    ...
                                    <input
                                            ...
                                            @if(in_array($librarian->id, $id_l))
                                    checked @endif
                                    class="opacity-0"
                                    type="checkbox" name="id_librarian[]"
                                    value="{{$librarian->id}}">
        ...
        <td class="px-6 py-3 text-sm leading-5 text-right whitespace-no-wrap">
            ...
            <div
                ...
                <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                    ...
                    <div class="py-1">
                        <a href="{{route('rented-info', $book->rent->id)}}"
                           tabindex="0"
                        ...
                        <a href="{{route('return-book', $book->rent->book->title)}}"
                           tabindex="0"
                           class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                           role="menuitem">
        ...
        <td class="px-6 py-3 text-sm leading-5 text-right whitespace-no-wrap">
            ...
            <div
                ...
                <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                     ...
                     id="headlessui-menu-items-117" role="menu">
                    <div class="py-1">
                        <a href="{{route('rented-info', $book->rent->book->id)}}"
                           tabindex="0"
                           class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                           role="menuitem">
                            <i class="far fa-file mr-[10px] ml-[5px] py-1"></i>
    ...
    <div class="mx-[50px]">
        <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
            ...
            <p class="font-medium text-white">Trenutno nema rezultata za traženi
                kriterijum!</p>
        </div>
    </div>

...
@section('title')
    ...
    <!-- Title -->
    <title>{{__('Rezerviši knjigu | Online biblioteka')}}</title>
                ...
                <div class="flex flex-row ml-[30px]">
                    <div class="w-[50%] mb-[100px]">
                        <h3 class="mt-[20px] mb-[10px]">Rezerviši knjigu
                            ...
                            @if (session()->has('reservation-failed'))
                                <div id="hideDiv"
                                    ...
                                    <span class="sr-only">Info</span>
                                    <div>
                                        <span class="font-medium">Bezuspješno!</span>
                                ...
                                <div class="flex p-4 mt-2 mb-1 text-sm text-white bg-blue-700 rounded-lg"
                                    ...
                                    <span class="sr-only">Info</span>
                                    <div>
                                        <span class="font-medium">Informacija!</span>
                                        Kontaktirajte bibliotekara kako biste mogli
                                        istovremeno rezervisati više knjiga (promijenite
                                        paket).
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="mt-[20px]">
                            ...
                            Auth::user()->type->id == 3)
                                <span>Izaberi učenika za koga se knjiga rezerviše <span

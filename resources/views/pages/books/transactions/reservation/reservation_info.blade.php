    ...
    <div class="heading">
        <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
            ...
            <div class="pt-[24px] mr-[30px]">
                <a href="{{route('write-off', $reservation->book->title)}}" class="inline hover:text-blue-600">
                    <i class="fas fa-level-up-alt mr-[3px]"></i>
                    Otpiši knjigu
                </a>
                <a href="{{route('rent-book', $reservation->book->title)}}" class="inline hover:text-blue-600 ml-[20px] pr-[10px]">
                    <i class="far fa-hand-scissors mr-[3px]"></i>
                    Izdaj knjigu
                </a>
                <a href="{{route('return-book', $reservation->book->title)}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                ...
                <div
                    ...
                    <div class="absolute right-0 w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                        ...
                        <div class="py-1">
                            <a href="{{route('edit-book', $reservation->book->title)}}" tabindex="0"

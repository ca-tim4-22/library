        ...
        <div class="flex flex-row justify-between">
            <div class="mr-[30px]">
                ...
                <div class="text-[14px] flex flex-row mb-[30px]">
                    ...
                    <div class="ml-[25px]">
                        <div class="rounded">
                            <div class="relative">
                                <button class="w-auto rounded focus:outline-none"
                                        id="knjigeMenu">
                                    @if ($selected_b != [])
                            ...
                            <div class="relative">
                                <button class="w-auto rounded focus:outline-none datumDrop-toggle">
                                    <span class="float-left">
                                        ...
                                        Datum: Svi
                                        @else 
                                        Datum: od <span style="color: #4558BE">{{$from}}</span> do <span
                                                style="color: #4558BE">{{$to}}</span>
                                        @endif
                                        <i
                                                class="px-[7px] fas fa-angle-down"></i></span>
                                </button>
                ...
                <div class="ml-[35px] cursor-pointer hover:text-blue-600">
                    <a style="outline: none;"
                       href="{{route('dashboard-activity')}}"><i
                    ...
                    <div class="">
                        <p>
                            ...
                            <a href="{{route('show-book', $rent->book->title)}}">
                                ...
                                : 'izdala'}} knjigu <span class="font-medium">{{$rent->book->title}} </span>
                            </a>
                ...
                <div class="ml-[15px] mt-[5px] flex flex-col">
                    ...
                    <div class="">
                        <p>
                            ...
                            @if ($reservation->reservation->made_by->type->id ==
                            2)
                            ...
                            <a href="{{route('show-book', $reservation->reservation->book->title)}}">
                                je
                                {{$reservation->reservation->made_by->gender->id
                                == 1 ? 'rezervisao' : 'rezervisala'}} knjigu
                                <span class="font-medium">{{$reservation->reservation->book->title}} </span>
                            </a>
            ...
            <div class="mx-[50px]">
                <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                    ...
                    <p class="font-medium text-white">Ne postoji aktivnost sa
                        tim kriterijumom! </p>
                </div>
            </div>
            ...
            <div class="mx-[50px]">
                <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                    ...
                    <p class="font-medium text-white">{{__('Trenutno nema aktivnosti za prikazivanje!')}}</p>
                </div>
            </div>

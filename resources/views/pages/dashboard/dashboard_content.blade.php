    ...
    <div style="display:none;" id="myDiv">
        ...
        <div class="heading mt-[28px]">
            <h1 class="pl-[30px] pb-[2px]  border-b-[1px] border-[#e4dfdf] ">
                ...
                <div id="hideDiv"
                    ...
                    <span class="sr-only">Info</span>
                    <div>
                        <span class="font-medium">{{__('Bezuspješno')}}!</span>
                        {{session('deny')}}
                    </div>
                </div>
                @endif
        ...
        <div class="pl-[30px] scroll height-dashboard overflow-auto mt-[20px] pb-[30px]">
            <div class="flex flex-row justify-between">
                                                   ...
                                                   class="text-[#2196f3] hover:text-blue-600">
                                                    ...
                                                    <a>
                                                        ...
                                                        <a href="{{route('show-book', $rent->book->title)}}">
                                                            {{__('je')}}
                                                            {{$rent->librarian->gender->id
                                                            == 1 ? __('izdao') :
                                                            __('izdala')}}
                                                            {{__('knjigu')}}
                                                            <span class="font-medium">{{$rent->book->title}} </span>
                                                        </a>
                ...
                <div class="mr-[50px]">
                <span id="tooltip_2" style="font-size: 1.3em"
                      class="cursor-default uppercase mr-[0px] text-left"
                >
                            ...
                            <a href="{{route('active-reservations')}}"
                               class="text-[#2196f3] hover:text-blue-600">
                                <i style="cursor: default"
                                   class="fas fa-calendar-alt mr-[4px]"
                                   aria-hidden="true"></i>
                                {{__('Prikaži sve')}}
                            </a>
                        </div>

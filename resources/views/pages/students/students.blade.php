...
<script>
    swal({
       title: "Uspješno!", 
       text: "Uspješno ste dodali učenika!", 
       timer: 2500,
       type: "success",
    });
</script>
...
<form method="GET" action="{{ route('all-student') }}">
    <div class="relative text-gray-600 focus-within:text-gray-400">
        ...
        <div class="inline-block min-w-full px-[30px] pt-3 align-middle bg-white rounded-bl-lg rounded-br-lg shadow-dashboard">
           ...
           href="{{route('all-student')}}"><i class="fas fa-arrow-left mr-[5px]"></i>{{__('Nazad')}}</a>
        @endif 

            @if (count($students) > 0)

            <button type="submit" class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE] button delete-all-students"  data-url="">
                <div class="icon">
                    <svg class="top">
                        <use xlink:href="#top">
                    </svg>
            ...
            <table id="sort" class="shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]" id="myTable">
                ...
                <tbody class="bg-white" id="tablex">
                    ...
                    <tr class="hover:bg-gray-200 hover:shadow-md border-[1px] border-[#e4dfdf]">
                        ...
                        <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">{{$student->login_count == 0 ? __('Korisnik se nikada nije ulogovao.') : $student->last_login_at->diffForHumans()}}</td>
                            ...
                            <div
                                ...
                                <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                    ...
                                    <div class="py-1">
                                        ...
                                        <a 
                                        href="{{route('edit-student', $student->username)}}" tabindex="0"
                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                            role="menuitem">
...
<script type="text/javascript">
    ...
    swal({
     title: "Greška!",
     text: "Morate selektovati makar jednog učenika.",
     type: "error",
     timer: 1500,

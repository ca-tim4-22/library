...
<!-- Title -->
<title>{{__('Profil učenika | Online biblioteka')}}</title>
        ...
        <div class="heading">
            <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                ...
                <div class="pt-[24px] pr-[30px]">
                    ...
                    <a href="{{route('edit-student', $student->username)}}"
                        ...
                        <div class="absolute right-0 w-16 mt-[10px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                            ...
                            <div class="py-1">
                                ...
                                <button type="submit"
                                    ...
                                    data-id="{{$student->id}}"
                                    data-action="{{ route('destroy-student',
                                    $student->id) }}"
            ...
            <div class="flex flex-row">
                <div class="mr-[30px]">
                    ...
                    <div class="mt-[40px]">
                        ...
                        <p class="font-medium">{{__($student->gender->name)}}</p>
                    </div>
                    <div class="mt-[40px]">
                        ...
                        <p class="font-medium">
                            ...
                            {{__('Učenik se nikada nije ulogovao na platformu.')}}
                            @else
                            {{__('Učenica se nikada nije ulogovala na platformu.')}}
                            @endif
                            @else
                            {{$student->login_count}}
                            @endif
                    ...
                    <div class="mt-[40px]">
                        <span class="text-gray-500">
                            {{__('Poslednji put')}} {{$student->gender->id == 1 ? __('ulogovan') : __('ulogovana')}}
                        </span>
                        <p class="font-medium">
                            @if ($student->login_count <= 0)
                            @if ($student->gender->id == 1)
...
<div
    ...
    <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
        ...
        <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
            <h3>{{__('Resetuj lozinku')}}: {{$student->name}}</h3>

...
<article>
    ...
    <div>
        <p>&mdash; <a href="https://perisicnikola37.github.io/nullable/"
                      target="_blank"><span>[nullable]</span></a> tim</p>
        <img src="{{asset('good_bye/img/good-bye-rocket.gif')}}" alt="Good Bye!"
             title="Good Bye!">
    </div>

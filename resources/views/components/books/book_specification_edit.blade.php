            ...
            <div class="flex flex-row ml-[30px]">
                <div class="w-[50%] mb-[150px]">
                    ...
                    <div class="mt-[20px]">
                        ...
                        <input type="tel" name="ISBN" id="isbn" class="flex w-[45%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsIsbn()" placeholder="978-3-16-148410-0" value="{{$book->ISBN}}"/>
                    </div>
                </div>
            </div>
    </div>
